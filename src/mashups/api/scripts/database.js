...
WebDev.Database = new Object();

WebDev.Database.create = function() {
    return new WebDev.Database._Impl();
};

/*==================================================
 *  WebDev.Database._Impl
 *==================================================
 */
WebDev.Database._Impl = function() {
    this._types = {};
    this._properties = {};
    this._propertyArray = {};
    ...
    var itemType = new WebDev.Database._Type("Item");
    itemType._custom = Exhibit.Database.l10n.itemType;
    this._types["Item"] = itemType;

    var labelProperty = new WebDev.Database._Property("label");
    ...
    var typeProperty = new WebDev.Database._Property("type");
    ...
    var uriProperty = new WebDev.Database._Property("uri");
    uriProperty._uri                    = "http://simile.mit.edu/2006/11/WebDev#uri";
...
WebDev.Database._Impl.prototype.createDatabase = function() {
    return WebDev.Database.create();
};

WebDev.Database._Impl.prototype.addListener = function(listener) {
    this._listeners.add(listener);
};

WebDev.Database._Impl.prototype.removeListener = function(listener) {
    this._listeners.remove(listener);
};

WebDev.Database._Impl.prototype.loadDataLinks = function(fDone) {
    var links = [];
    ...
    for (var h = 0; h < heads.length; h++) {
        ...
        for (var l = 0; l < linkElmts.length; l++) {
            ...
            if (link.rel.match(/\bWebDev\/data\b/)) {
                links.push(link);
            }
        }
    }
...
WebDev.Database._Impl.prototype._loadLinks = function(links, fDone) {
    links = [].concat(links);
    var database = this;
    var fNext = function() {
        while (links.length > 0) {
            ...
            var importer = WebDev.importers[type];
            if (importer) {
...
WebDev.Database._Impl.prototype.loadData = function(o, baseURI) {
...
WebDev.Database._Impl.prototype.loadTypes = function(typeEntries, baseURI) {
    ...
    try {
        ...
        for (var typeID in typeEntries) {
            ...
            if (typeID in this._types) {
                ...
                type = new WebDev.Database._Type(typeID);
...
WebDev.Database._Impl.prototype.loadProperties = function(propertyEntries, baseURI) {
    ...
    try {
        ...
        for (var propertyID in propertyEntries) {
            ...
            if (propertyID in this._properties) {
                ...
                property = new WebDev.Database._Property(propertyID, this);
...
WebDev.Database._Impl.prototype.loadItems = function(itemEntries, baseURI) {
    ...
    try {
        ...
        var spo = this._spo;
        var ops = this._ops;
        var indexPut = WebDev.Database._indexPut;
...
WebDev.Database._Impl.prototype.getType = function(typeID) {
    return this._types[typeID];
};

WebDev.Database._Impl.prototype.getProperty = function(propertyID) {
 ...
 */
WebDev.Database._Impl.prototype.getAllProperties = function() {
...
WebDev.Database._Impl.prototype.getAllItems = function() {
...
WebDev.Database._Impl.prototype.getAllItemsCount = function() {
    return this._items.size();
};

WebDev.Database._Impl.prototype.containsItem = function(itemID) {
    return this._items.contains(itemID);
};

WebDev.Database._Impl.prototype.getNamespaces = function(idToQualifiedName, prefixToBase) {
    var bases = {};
    for (var propertyID in this._properties) {
...
WebDev.Database._Impl.prototype._loadItem = function(itemEntry, indexFunction, baseURI) {
...
WebDev.Database._Impl.prototype._ensureTypeExists = function(typeID, baseURI) {
    if (!(typeID in this._types)) {
        var type = new WebDev.Database._Type(typeID);
...
WebDev.Database._Impl.prototype._ensurePropertyExists = function(propertyID, baseURI) {
    if (!(propertyID in this._properties)) {
        var property = new WebDev.Database._Property(propertyID);
...
WebDev.Database._indexPut = function(index, x, y, z) {
    var hash = index[x];
    if (!hash) {
        hash = {};
        index[x] = hash;
...
WebDev.Database._indexPutList = function(index, x, y, list) {
    var hash = index[x];
    if (!hash) {
        hash = {};
        index[x] = hash;
...
WebDev.Database._indexRemove = function(index, x, y, z) {
    var hash = index[x];
    if (!hash) {
        return false;
    }
...
WebDev.Database._indexRemoveList = function(index, x, y) {
    var hash = index[x];
    if (!hash) {
        return null;
    }
...
WebDev.Database._Impl.prototype._indexFillSet = function(index, x, y, set, filter) {
    var hash = index[x];
    if (hash) {
        var array = hash[y];
        if (array) {
...
WebDev.Database._Impl.prototype._indexCountDistinct = function(index, x, y, filter) {
    var count = 0;
    var hash = index[x];
    if (hash) {
        var array = hash[y];
...
WebDev.Database._Impl.prototype._get = function(index, x, y, set, filter) {
    if (!set) {
        set = new Exhibit.Set();
    }
...
WebDev.Database._Impl.prototype._getUnion = function(index, xSet, y, set, filter) {
    if (!set) {
        set = new Exhibit.Set();
    }
...
WebDev.Database._Impl.prototype._countDistinctUnion = function(index, xSet, y, filter) {
    var count = 0;
    var database = this;
    xSet.visit(function(x) {
...
WebDev.Database._Impl.prototype._countDistinct = function(index, x, y, filter) {
    return this._indexCountDistinct(index, x, y, filter);
};

WebDev.Database._Impl.prototype._getProperties = function(index, x) {
    var hash = index[x];
    var properties = []
    if (hash) {
        for (var p in hash) {
...
WebDev.Database._Impl.prototype.getObjects = function(s, p, set, filter) {
    return this._get(this._spo, s, p, set, filter);
};

WebDev.Database._Impl.prototype.countDistinctObjects = function(s, p, filter) {
    return this._countDistinct(this._spo, s, p, filter);
};

WebDev.Database._Impl.prototype.getObjectsUnion = function(subjects, p, set, filter) {
    return this._getUnion(this._spo, subjects, p, set, filter);
};

WebDev.Database._Impl.prototype.countDistinctObjectsUnion = function(subjects, p, filter) {
    return this._countDistinctUnion(this._spo, subjects, p, filter);
};

WebDev.Database._Impl.prototype.getSubjects = function(o, p, set, filter) {
    return this._get(this._ops, o, p, set, filter);
};

WebDev.Database._Impl.prototype.countDistinctSubjects = function(o, p, filter) {
    return this._countDistinct(this._ops, o, p, filter);
};

WebDev.Database._Impl.prototype.getSubjectsUnion = function(objects, p, set, filter) {
    return this._getUnion(this._ops, objects, p, set, filter);
};

WebDev.Database._Impl.prototype.countDistinctSubjectsUnion = function(objects, p, filter) {
    return this._countDistinctUnion(this._ops, objects, p, filter);
};

WebDev.Database._Impl.prototype.getObject = function(s, p) {
...
WebDev.Database._Impl.prototype.getSubject = function(o, p) {
...
WebDev.Database._Impl.prototype.getForwardProperties = function(s) {
    return this._getProperties(this._spo, s);
};

WebDev.Database._Impl.prototype.getBackwardProperties = function(o) {
    return this._getProperties(this._ops, o);
};

WebDev.Database._Impl.prototype.getSubjectsInRange = function(p, min, max, inclusive, set, filter) {
...
WebDev.Database._Impl.prototype.getTypeIDs = function(set) {
    return this.getObjectsUnion(set, "type", null, null);
};

WebDev.Database._Impl.prototype.addStatement = function(s, p, o) {
    var indexPut = WebDev.Database._indexPut;
    indexPut(this._spo, s, p, o);
    indexPut(this._ops, o, p, s);
};

WebDev.Database._Impl.prototype.removeStatement = function(s, p, o) {
    var indexRemove = WebDev.Database._indexRemove;
...
WebDev.Database._Impl.prototype.removeObjects = function(s, p) {
    var indexRemove = WebDev.Database._indexRemove;
    var indexRemoveList = WebDev.Database._indexRemoveList;
...
WebDev.Database._Impl.prototype.removeSubjects = function(o, p) {
    var indexRemove = WebDev.Database._indexRemove;
    var indexRemoveList = WebDev.Database._indexRemoveList;
...
WebDev.Database._Impl.prototype.removeAllStatements = function() {
...
/*==================================================
 *  WebDev.Database._Type
 *==================================================
 */
WebDev.Database._Type = function(id) {
    this._id = id;
    this._custom = {};
};

WebDev.Database._Type.prototype = {
...
/*==================================================
 *  WebDev.Database._Property
 *==================================================
 */
WebDev.Database._Property = function(id, database) {
    this._id = id;
    this._database = database;
    this._rangeIndex = null;
};

WebDev.Database._Property.prototype = {
    getID:          function() { return this._id; },
...
WebDev.Database._Property.prototype._onNewData = function() {
    this._rangeIndex = null;
};

WebDev.Database._Property.prototype.getRangeIndex = function() {
...
WebDev.Database._Property.prototype._buildRangeIndex = function() {
    var getter;
    ...
    this._rangeIndex = new WebDev.Database._RangeIndex(
...
/*==================================================
 *  WebDev.Database._RangeIndex
 *==================================================
 */
WebDev.Database._RangeIndex = function(items, getter) {
    pairs = [];
...
WebDev.Database._RangeIndex.prototype.getCount = function() {
    return this._pairs.count();
};

WebDev.Database._RangeIndex.prototype.getMin = function() {
    return this._pairs.length > 0 ? 
        this._pairs[0].value : 
        Number.POSITIVE_INFINITY;
};

WebDev.Database._RangeIndex.prototype.getMax = function() {
    return this._pairs.length > 0 ? 
        this._pairs[this._pairs.length - 1].value : 
        Number.NEGATIVE_INFINITY;
};

WebDev.Database._RangeIndex.prototype.getRange = function(visitor, min, max, inclusive) {
...
WebDev.Database._RangeIndex.prototype.getSubjectsInRange = function(min, max, inclusive, set, filter) {
    if (!set) {
        set = new Exhibit.Set();
    }
...
WebDev.Database._RangeIndex.prototype.countRange = function(min, max, inclusive) {
    var startIndex = this._indexOf(min);
...
WebDev.Database._RangeIndex.prototype._indexOf = function(v) {
    var pairs = this._pairs;
