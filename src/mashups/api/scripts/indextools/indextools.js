...
function createITT(){
  ...
  function ITT(pid,trdom,sectrdom){
    this.version="4.0";
  this.dbg=false;this.PID=pid;this.BD=(window.location.protocol.indexOf('https:')==0?'https://'+sectrdom:'http://'+trdom);this.BU=this.BD+'/p.pl?a='+this.PID+'&v='+this.version;this.URL=document.location;this.cfn=new Array;this.cfv=new Array;this._ud="undefined";this.IT="";var nan=navigator.appName;this.na=(nan=="Netscape");this.ns=(nan.substring(0,9)=="Microsoft");this.date=new Date();this.DOCUMENTNAME=document.title;this.CAMPAIGN="";this.CMPPARM="";this.PROMO="";this.PROMOPARM="";this.EXCL="";this.FPCR="";this.FPCN='fpc'+this.PID;this.FPCV="";this.FPCD="";this.itvs="";this.itsid="";this.itvid="";if(typeof window.ITTs==this._ud)window.ITTs=new Array;this.idx=window.ITTs.length;window.ITTs[this.idx]=this;eval("ITT.prototype._e=function(){window.ITTs["+this.idx+"]._track(false,true);return true;}");this.ita=["URL","f","DOCUMENTNAME","b","DOCUMENTGROUP","c","MEMBERID","m","ACTION","x","AMOUNT","xa","ORDERID","oc","_S_TAX","xt","_S_SHIPPING","xs","_S_DISCOUNT","xd","_S_SKU","p","_S_PRODUCTS","u","_S_UNITS","q","_S_AMOUNTS","r"];for(i=0;i<10;i++){eval("window.ITTs["+this.idx+"].ita[window.ITTs["+this.idx+"].ita.length]=\"_S_P"+(1+i)+"\";window.ITTs["+this.idx+"].ita[window.ITTs["+this.idx+"].ita.length]=\"p"+(1+i)+"\"");}if(typeof window.imgs==this._ud)window.imgs=new Array;}
...
ITT.prototype.ol=function(){if(((window.screen)||((new Array()).toSource)||((new Array()).shift&&ns))&&(navigator.userAgent.indexOf('Mac')<0)){if(window.onload){if(!window._s_itt_ool)window._s_itt_ool=window.onload;}}
eval("function olo(){if (window._s_itt_ool)window._s_itt_ool();var ln = document.links.length;for (var i = 0; i < ln; i++){if (document.links[i].onclick)document.links[i].oc = document.links[i].onclick;eval(\"document.links[i].onclick=function(){return window.ITTs["+this.idx+"].oco(this);}\");}}");
window.onload=olo;}
...
ITT.prototype._track=function(_d,_i){t="";r=document.referrer;if(typeof _S_REFERRER!=this._ud&&_S_REFERRER.length>0)r=_S_REFERRER;else{if((navigator.userAgent.indexOf('Mac')>=0)&&(navigator.userAgent.indexOf('MSIE 4')>=0))r=document.referrer;else if(_d){window._itt_e=window.onerror;window.onerror=this._e;if(document.location!=top.location){r=top.document.referrer;t=top.location.href;}}else{this.IT+="&nr=t";}}if(window._itt_e)window.onerror=window._itt_e;else window.onerror=null;this.pp();if(r.length>0)this.IT+="&e="+escape(r);if(t.length>0)this.IT+="&t="+escape(t);
var cs=this.FPCSupport();this.date=new Date();this.IT+="&d="+escape(this.date.toGMTString());this.IT+="&n="+escape(parseInt(this.date.getTimezoneOffset()/60));this.IT+="&g="+escape(this.na?navigator.language:navigator.userLanguage);this.IT+="&h="+escape((navigator.javaEnabled()?'Y':'N'));this.IT+="&j="+escape(screen.width+'x'+screen.height);this.IT+="&k="+escape((this.ns)?screen.colorDepth:screen.pixelDepth);this.IT+="&l="+((cs)?"true":"false");if(this.CAMPAIGN!="")this.IT+="&cp="+escape(this.CAMPAIGN);if(this.CMPPARM!="")this.IT+="&cp="+escape(gcpn(this.CMPPARM));if(this.PROMO!="")this.IT+="&scp="+escape(this.PROMO);if(this.PROMOPARM!="")this.IT+="&scp="+escape(gcpn(this.PROMOPARM));
if(cs&&_i)this.fpc();else this.trk("");}
